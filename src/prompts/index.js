...
Step1で具体化された「リサーチクエスチョン（または実践報告・QIテーマ）」に基づき、それを実現するための最適な研究デザインを10案提案してください。

【実行指示】
1. 最新の知見において未解明な点や、研究の意義が高いと思われる展開を、具体的な研究デザインとして10個提案してください。
2. 各提案について、FINER基準（Feasible, Interesting, Novel, Ethical, Relevant）に基づく評価を含めてください。
...
【出力形式（JSONのみ）】
{
  "proposals": [
    {
      "design": "リサーチクエスチョンの文言",
      "vision": "簡単な研究のビジョン（2〜3文）",
      "finer": {
        "f": "実現可能性（Feasible）の根拠",
        "i": "面白さ（Interesting）の根拠",
        "n": "新規性（Novel）の根拠",
        "e": "倫理性（Ethical）の根拠",
        "r": "関連性（Relevant）の根拠"
      },
      "rating": 3,
      "reason": "熟練研究者としての推薦理由（FINER評価の要約）"
    }
  ]
}`,
        ...
        proposals: [
            {
                ...
                vision: '現在の属人的な退院支援を標準化し、多職種が共通の評価指標で介入することで、再入院率の低下を目指す。',
                finer: { f: true, i: true, n: true, e: true, r: true },
                rating: 3,
                reason: '既存の課題に対し、介入内容が明確で実現可能性が高く、臨床的意義も極めて大きいため。',
            },
            {
                design: '高齢患者の退院支援における看護師の役割と多職種連携の阻害要因：質的記述的研究',
                vision: '量的研究では見えにくい連携の「壁」を質的に明文化し、組織的な改善策の基盤を作る。',
                finer: { f: true, i: true, n: true, e: true, r: true },
                rating: 2,
                reason: '現場の個別的な課題を深く掘り下げるのに適しており、教育的意義が高い。',
            },
        ],
    }),
